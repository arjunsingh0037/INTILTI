...
function url_display_frame($url, $cm, $course) {
    ...
    if ($frame === 'top') {
        ...
        $navurl = "$CFG->wwwroot/mod/url/view1.php?id=$cm->id&amp;frameset=top";
...
<html dir="$dir">
  ...
  <frameset cols=15%,85%">
    <frame src="$navurl" title="$modulename" noresize="noresize" style="background-color:#222d32"/>
    <frame src="$exteurl" title="$contentframetitle" noresize="noresize"/>
  </frameset>
</html>
EOF;
